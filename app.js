...
const activiteData = {
  ...
  bonnes_adresses: {
    ...
    highlights: ['Restaurant Les Douzes — cuisine française soignée et savoureuse en bord de rivière', 'Château d\'Ayres — cuisine gastronomique raffinée dans un château', 'La Cardabelle — pizzas artisanales et cuisine traditionnelle', 'Grand Hôtel de France — cuisine française traditionnelle au cœur du village', 'Aven Gourmand — cuisine française soignée et savoureuse', 'Restaurant Family — spécialités régionales et ambiance conviviale'],
