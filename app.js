...
const activiteData = {
  ...
  bonnes_adresses: {
    ...
    highlights: ['Restaurant Saint-Sauveur — aligot maison (notre coup de coeur !)', 'Château d\'Ayres — spécialités gibier et truites', 'La Cardabelle — poissons de rivière en bord de Jonte', 'Grand Hôtel de France — terrasse panoramique sur les gorges', 'Aven Gourmand — cadre naturel exceptionnel', 'Restaurant Family — ancienne meunerie reconvertie'],
